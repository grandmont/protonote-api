...
const modelsInfo = {
  ...
  Integration: ["id", "createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "userId"]
};
...
const outputsInfo = {
  ...
  IntegrationGroupBy: ["id", "createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "userId", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  IntegrationCountAggregate: ["id", "createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "userId", "_all"],
  IntegrationAvgAggregate: ["id", "userId"],
  IntegrationSumAggregate: ["id", "userId"],
  IntegrationMinAggregate: ["id", "createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "userId"],
  IntegrationMaxAggregate: ["id", "createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "userId"]
};
...
const inputsInfo = {
  ...
  IntegrationWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "user", "userId"],
  IntegrationOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "user", "userId"],
  IntegrationWhereUniqueInput: ["id"],
  IntegrationOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "userId", "_count", "_avg", "_max", "_min", "_sum"],
  IntegrationScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "userId"],
  ...
  IntegrationCreateInput: ["createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "user"],
  IntegrationUpdateInput: ["createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "user"],
  IntegrationCreateManyInput: ["id", "createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "userId"],
  IntegrationUpdateManyMutationInput: ["createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken"],
  ...
  IntegrationCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "userId"],
  IntegrationAvgOrderByAggregateInput: ["id", "userId"],
  IntegrationMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "userId"],
  IntegrationMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "userId"],
  ...
  IntegrationCreateWithoutUserInput: ["createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken"],
  ...
  IntegrationScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken", "userId"],
  ...
  IntegrationCreateManyUserInput: ["id", "createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken"],
  ProtoUpdateWithoutUserInput: ["createdAt", "updatedAt", "title", "description", "dateString", "integrations"],
  IntegrationUpdateWithoutUserInput: ["createdAt", "updatedAt", "externalId", "provider", "status", "refreshToken"],
