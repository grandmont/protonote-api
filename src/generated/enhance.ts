...
const modelsInfo = {
  ...
  IntegrationData: ["id", "createdAt", "updatedAt", "search", "data", "integrationId", "protoId"]
};
...
const outputsInfo = {
  ...
  IntegrationDataGroupBy: ["id", "createdAt", "updatedAt", "search", "data", "integrationId", "protoId", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  IntegrationDataCountAggregate: ["id", "createdAt", "updatedAt", "search", "data", "integrationId", "protoId", "_all"],
  IntegrationDataAvgAggregate: ["id", "integrationId", "protoId"],
  IntegrationDataSumAggregate: ["id", "integrationId", "protoId"],
  IntegrationDataMinAggregate: ["id", "createdAt", "updatedAt", "search", "data", "integrationId", "protoId"],
  IntegrationDataMaxAggregate: ["id", "createdAt", "updatedAt", "search", "data", "integrationId", "protoId"]
};
...
const inputsInfo = {
  ...
  IntegrationDataWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "search", "data", "integration", "integrationId", "proto", "protoId"],
  IntegrationDataOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "search", "data", "integration", "integrationId", "proto", "protoId"],
  IntegrationDataWhereUniqueInput: ["id"],
  IntegrationDataOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "search", "data", "integrationId", "protoId", "_count", "_avg", "_max", "_min", "_sum"],
  IntegrationDataScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "search", "data", "integrationId", "protoId"],
  ...
  IntegrationDataCreateInput: ["createdAt", "updatedAt", "search", "data", "integration", "proto"],
  IntegrationDataUpdateInput: ["createdAt", "updatedAt", "search", "data", "integration", "proto"],
  IntegrationDataCreateManyInput: ["id", "createdAt", "updatedAt", "search", "data", "integrationId", "protoId"],
  IntegrationDataUpdateManyMutationInput: ["createdAt", "updatedAt", "search", "data"],
  ...
  IntegrationDataCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "search", "data", "integrationId", "protoId"],
  IntegrationDataAvgOrderByAggregateInput: ["id", "integrationId", "protoId"],
  IntegrationDataMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "search", "data", "integrationId", "protoId"],
  IntegrationDataMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "search", "data", "integrationId", "protoId"],
  ...
  IntegrationDataCreateWithoutProtoInput: ["createdAt", "updatedAt", "search", "data", "integration"],
  ...
  IntegrationDataScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "search", "data", "integrationId", "protoId"],
  ...
  IntegrationDataCreateWithoutIntegrationInput: ["createdAt", "updatedAt", "search", "data", "proto"],
  ...
  IntegrationDataCreateManyProtoInput: ["id", "createdAt", "updatedAt", "search", "data", "integrationId"],
  IntegrationDataUpdateWithoutProtoInput: ["createdAt", "updatedAt", "search", "data", "integration"],
  IntegrationDataCreateManyIntegrationInput: ["id", "createdAt", "updatedAt", "search", "data", "protoId"],
  IntegrationDataUpdateWithoutIntegrationInput: ["createdAt", "updatedAt", "search", "data", "proto"]
};
